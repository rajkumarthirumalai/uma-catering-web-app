...
document.addEventListener('DOMContentLoaded', () => {
  ...
  function copyPhoneNumber() {
    ...
    clipboardIcon.classList.add("bi-check2-all");

    // Update Bootstrap tooltip content
    $('#copyButton').attr('title', 'Copied!').tooltip('show');

    // Reset back to the original icon and Bootstrap tooltip content after a delay
    setTimeout(function () {
      clipboardIcon.classList.remove("bi-check2-all");
      clipboardIcon.classList.add("bi-clipboard");
      $('#copyButton').attr('data-original-title', 'Copy to Clipboard').tooltip('hide');
    }, 2000); // Reset back to the original icon and Bootstrap tooltip after 2 seconds
